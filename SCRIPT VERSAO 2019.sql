...
/* SINTAXE BÁSICA DE INSERÇÃO - INSERT INTO TABLE... */
...
('CARLA','F','CARLA@TERATI.COM.BR',7745828,'66587458','SAMAUEL SILVA - CENTRO - BELO HOORIZONTE - MG');
				   
                  
				   
				   
/* OUTRO EXEMPLO COM CPF 11 DIGITOS */

INSERT INTO CLIENTE(NOME,SEXO,ENDEREÇO,TELEFONE,CPF) VALUES('CLARA','F','SENADOR SOARES -TIJUCA - RIO DE JANEIRO - RJ','995859103',95845365814);
...
INSERT INTO LIVROS VALUES('Hábitos Saudavéis','Eduardo Santos','M',630,'Beta',150,'RJ',2019);
INSERT INTO LIVROS VALUES('A Casa Marrom','Hermes Macedo','M',250,'Bubba',60,'MG',2016);
INSERT INTO LIVROS VALUES('Estácio Querido','Geraldo Francisco','M',310,'Insignia',100,'ES',2015);
INSERT INTO LIVROS VALUES('Para sempre amigas','Leda Silva','F',510,'Insignia',78,'ES',2011);
INSERT INTO LIVROS VALUES('Copas Inesquecíveis','Marco Alcantara','M',200,'Larson',130,'RS',2018);
INSERT INTO LIVROS VALUES('O poder da mente','Clara Maíra','F',120,'Continental',56,'SP',2017);
...
/*4 - TRAZER O NOME DO LIVRO E O NÚMERO DE PÁGINAS DE LIVROS PUBLICADOS POR AUTORES DO SEXO FEMININO */
...
/*5 - TRAZER OS VALORES DOS LIVROS PUBLICADOS POR EDITORAS DE SÃO PAULO */
...
/* OPERADORES LÓGICOS */
/* OR - PARA QUE A SAÍDA DA QUERY SEJA VERDADEIRA, BASTA QUE APENAS UMA CONDIÇÃO SEJA VERDADEIRAS.
AND - PARA QUE A SAÍDA SEJA VERDADEIRA TODAS AS CONDIÇÕES PRESISAM SER VERDADDEIRAS.
 */
...
SELECT ENDEREÇO, COUNT(*) FROM CLIENTE
GROUP BY ENDEREÇO;
